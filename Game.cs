...
namespace Hospital_Escape
{
    ...
    class Game
    {
        ...
        public Rooms createWorld()
        {
            ...
            cafe_door = Door.CreateDoor(HelpDesk, Cafe_room, true);
        ...
        public void patientSaved(Notification notification)
        {
            ...
            if(saved == 4)
            {
                cafe_door.Locked = false;
                Console.WriteLine("Cafe has been unlocked");
            }
